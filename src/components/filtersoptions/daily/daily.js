...
const Daily = (props) => {
  ...
  const toggleSelected = () => {
    if (selected) {
      array.slice(0, 1).forEach((element, i) => {
  ...
  return (
    <div>
      ...
      <div className="d-flex justify-content-center mt-3 text-white font-weight-bold text-center">
        {array.slice(0, 1).map((postion, index) => (
          <div id="card">
            <div className="row h-100">
              <div className="col-6">
                ...
                <h6 className="font-weight-bold" id="tag">
                  {" "}
                  high:<span id={"highTemp" + index}>{postion.temp.max} F</span>
                </h6>
              </div>
              <div className="col-6">
                <div id="time">
                ...
                <div className="x ">
                  low: <span id={"lowTemp" + index}>{postion.temp.min} F</span>
                </div>
              </div>
            </div>
          </div>
